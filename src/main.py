...
def should_continue_main_bot(state: TicketProcessorAgentState) -> str:
    ...
    if "ticket_processing_state" in state and state["ticket_processing_state"] == BotState.END_CONVERSATION:
    ...
    if "ticket_processing_state" in state and state["ticket_processing_state"] == BotState.TICKET_CHOSEN:
...
def should_continue_ticket_processing_bot(state: TicketProcessorAgentState) -> str:
    ...
    if "ticket_processing_state" in state and state["ticket_processing_state"] == BotState.TICKET_PROCESSING_COMPLETED:
